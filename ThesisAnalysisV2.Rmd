...
networks <- data.frame(
           ID = rep(1:N, each = 2),
           Wave = rep(c("T1", "T2"), N),
           # Contemporaneous network: lower triangle in col by col format
           PCC_PA_NA = NA,
           PCC_PA_Stress = NA,
           PCC_PA_Task = NA,
           PCC_PA_Rank1 = NA,
           ...
           PCC_Tasks_Rank2 = NA,
           PCC_Rank1_Rank2 = NA,
           # Temporal networks: full matrix in col by col format
           PDC_PA_PA = NA,
           PDC_PA_NA = NA,
           PDC_PA_Stress = NA,
           PDC_PA_Tasks = NA,
           ...
           EBIC = NA, # optimal (e)bic derived
           gamma = NA,
           minimal_lambda = NA, # minimum Lambda value tested 
           mean_PA = NA, 
           mean_NA = NA, 
           mean_Stress = NA,
           mean_tasks = NA, 
