...
for (i in 1:N){
    for (v in seq_along(emaLabels)){
      dat_imputed[dat_imputed$participantID == i, 5+v] <- na_kalman(dat[dat_imputed$participantID == i, 5+v])
    }
}
...
# plot networks
# Names for the Plot :
 names <- c("Positive Affect", "Negative Affect", "Stress Severity", 
            "Tasks")  # to do: add , Rank1, Rank2 names
