...
sum(networks$pr_zero_PCC == 100) # 1 empty contemp net total
sum(networks$pr_zero_PDC == 100) # 46 empty temp net total
...
fit <- lm(formula = PCCs_cor ~ 1 + gender + age + happy + swlsMean + neoN + neoE + neoO + neoA + neoC + nr_imputed + avg_BIC, data = data_merged
     )
summary(fit)
